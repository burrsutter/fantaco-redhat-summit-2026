...
Automated 4-prompt contextual chat test using Playwright MCP tools. Verifies login, chat functionality, context retention across prompts, skill creation, and skill invocation.
...
## Step 4: Prompt 1 — Establish identity and context
...
## Step 5: Prompt 2 — Context recall
...
## Step 6: Prompt 3 — Create the friendly-greeter skill
...
## Step 7: Prompt 4 — Invoke the skill + name recall
